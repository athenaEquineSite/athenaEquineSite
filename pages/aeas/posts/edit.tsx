        ...
        <div className={`${styles.editPostWrapper}`}>
            ...
            <form className={`${styles.viewForm}`}>
                <div>
                    ...
                    <input type="text" value={post.eng[0].title} id="titleEnglish" disabled />
                    <label htmlFor="postBodyEnglish">Post text: </label>
                    <textarea name="postBodyEng" id="postBodyEnglish" cols={30} rows={10} value={post.eng[0].postBody} disabled></textarea>
                </div>
                <div>
                    <h3>Norwegian Version</h3>
                    <label htmlFor="titleNorwegian">Title: </label>
                    <input type="text" value={post.nor[0].title} id="titleNorwegian" disabled />
                    <label htmlFor="postBodyNorwegian">Post text: </label>
                    <textarea name="postBodyNor" id="postBodyNorwegian" cols={30} rows={10} value={post.nor[0].postBody} disabled></textarea>
                </div>
            </form>
            <form onSubmit={handleUpdateForm} className={`${styles.updateForm}`}>
                <div>
                    ...
                    <input type="text" placeholder={post.eng[0].title} id="titleUpdateEnglish" required/>
                    <label htmlFor="postBodyUpdateEnglish">Post text: </label>
                    <textarea name="postBodyUpdateEng" id="postBodyUpdateEnglish" cols={30} rows={10} placeholder={post.eng[0].postBody} required></textarea>
                </div>
                <div>
                    <h3>Norwegian Version</h3>
                    <label htmlFor="titleUpdateNorwegian">Title: </label>
                    <input type="text" placeholder={post.nor[0].title} id="titleUpdateNorwegian" required/>
                    <label htmlFor="postBodyUpdateNorwegian">Post text: </label>
                    <textarea name="postBodyUpdateNor" id="postBodyUpdateNorwegian" cols={30} rows={10} placeholder={post.nor[0].postBody} required></textarea>
                </div>
